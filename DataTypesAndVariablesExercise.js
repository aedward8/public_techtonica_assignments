...
let dreamDestination = "The Maldives";
...
// num2 but not num1?
//
// For num1 the value has to be between 1 and 10 but NOT including 1 or 10. 
//For num 2 the values is between 1 and 10 but it can also include 1 and 10 as a value.
...
const myAnswerForExercise12 = null;  // also showed up as undefined
...
// A + B * 2 + D + C / 2:
const myAnswerForExercise15 = "R2D2"; // I think it all becomes a string, the number data types becomes a string

// Exercise 16 What is the value of A * B
const myAnswerForExercise16 = NaN; // Intially I thought this was "R" but after running it was shown to be "NaN"

// Exercise 17 What is the value of true || false
const myAnswerForExercise17 = true;  // I thought the value would be Boolean but it is actually true
...
const myAnswerForExercise22 = true; // I am not sure why this ran true when it should be false

// Congrats, you made it to the end!
// Did you find this easy or hard? If you used references, which ones helped you? 
// Please answer in a comment below.
//
// I am still confused about why exercise 22 ran true. I thought overall this was a good review exercise and 
// a good way for us to practice push our files into GitHub. I used the website Javascript.info as a resource as well
